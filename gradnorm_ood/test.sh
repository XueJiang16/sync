...
# ./custom_test_v4.sh new SUN /mapai/haowenguo/ckpt/ood_ckpt/resnet101_imagnet_LT_100e.pth new0408_v4/imagenet_LT /mapai/haowenguo/data/ood_data/ImageNet-LT/ImageNet_LT_train.txt 0
